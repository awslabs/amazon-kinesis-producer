...
#ifndef AWS_AUTH_CERTS_H_
#define AWS_AUTH_CERTS_H_

namespace aws {
namespace auth {

// This is the trust anchor cert for the kinesis cert chain.
static constexpr const char* VeriSignClass3PublicPrimaryG5(
R"(-----BEGIN CERTIFICATE-----
...
// For CloudWatch
static constexpr const char* VeriSignClass3PublicPrimary(
R"(-----BEGIN CERTIFICATE-----
